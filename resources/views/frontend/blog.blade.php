...
<section class="ls section_padding_top_100 section_padding_bottom_90 columns_margin_0 text-center">
<div class="container">
<div class="row columns_padding_25">
<div class="col-md-6">
<h2 class="section_header">{{ $This_Blog->blog_name }}</h2>
<hr class="divider_2_30 left main_bg_color">
<p>
{!! $This_Blog->blog_content !!}
</p>
</div>
<div class="col-md-6">
<img src="{{asset('images/'.$This_Blog->blog_image)}}" alt="">
</div>
</div>
</div>
</section>
