...
<input type="text" name="client_name" class="form-control" placeholder="Enter Name" required>
</div>
<div class="form-group">
...
<input type="text" name="review" class="form-control" placeholder="Enter Review" required>
</div>
<div class="form-group">
