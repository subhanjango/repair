							...
							<div class="panel-body">
								...
								<form class="col-sm-12" method="{{$Method}}" action="{{$Action}}" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input type="text" name="service_name" class="form-control" value="{{$data->service_name}}" placeholder="Enter Name" required>
									</div>
									<div class="form-group">
										<label>About Service</label>
										<textarea name="service_about"style="width:100%" rows="10">{{$data->service_about}}</textarea>
									</div>
									<div class="form-group">
										...
										<input type="file" name="service_image" class="form-control" placeholder="Enter domain">
                                        <img style="width:50%" src="{{ url('images\\'.$data->service_image.'') }}">
									</div>
